...
if len(sys.argv) < 2:
    print("\033[93mUSAGE: python pv_decoder.py <input_file> [-d]\033[0m")
    sys.exit(1)

input_file   = sys.argv[1]
details_mode = "-d" in sys.argv
...
try:
    ...
    print("\033[91mERROR: " + input_file + " not found\033[0m")
    sys.exit(1)
